  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsuariosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuariosRecord> notificationsUsuariosRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final notificationsUsuariosRecord =
            notificationsUsuariosRecordList.isNotEmpty
                ? notificationsUsuariosRecordList.first
                : null;
            ...
            body: StreamBuilder<List<NotificationsRecord>>(
              stream: queryNotificationsRecord(
                queryBuilder: (notificationsRecord) =>
                  ...
                  'made_to',
                  isEqualTo: notificationsUsuariosRecord?.reference,
                ),
              ),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                ...
                return Column(
                  ...
                  children: List.generate(columnNotificationsRecordList.length,
                    ...
                    return NotificationCardWidget(
                      key: Key(
                          'Key8ti_${columnIndex}_of_${columnNotificationsRecordList.length}'),
                      notificationRef: columnNotificationsRecord.reference,
                    );
                  }),
                );
              },
