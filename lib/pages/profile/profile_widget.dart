                ...
                children: [
                              ...
                              child: Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    imageUrl: columnUsuariosRecord!.photoUrl,
                                    width: 100.0,
                                    height: 100.0,
                                    fit: BoxFit.cover,
                                  ),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        formatNumber(
                          columnUsuariosRecord!.followers.length,
                  ...
                  FutureBuilder<int>(
                    future: queryUsuariosRecordCount(
                      queryBuilder: (usuariosRecord) => usuariosRecord.where(
                        'followers',
                        arrayContains: columnUsuariosRecord?.reference,
                      ),
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                        ...
                        children: [
                          StreamBuilder<List<UsuariosRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<UsuariosRecord> textUsuariosRecordList =
                                  snapshot.data!;
                              // Return an empty Container when the item does not exist.
                              if (snapshot.data!.isEmpty) {
                                return Container();
