  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsuariosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuariosRecord> marketplaceUsuariosRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final marketplaceUsuariosRecord =
            marketplaceUsuariosRecordList.isNotEmpty
                ? marketplaceUsuariosRecordList.first
                : null;
                  ...
                  children: [
                    Padding(
                      ...
                      child: wrapWithModel(
                        ...
                        child: NavBarWidget(
                          photoUrl: marketplaceUsuariosRecord!.photoUrl,
                        ),
                      ),
                    ),
                                ...
                                child: StreamBuilder<List<ProductsRecord>>(
                                  stream: queryProductsRecord(
                                    queryBuilder: (productsRecord) =>
                                        productsRecord.orderBy('data_postagem',
                                            descending: true),
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    ...
                                    return GridView.builder(
                                      ...
                                      itemBuilder: (context, gridViewIndex) {
                                        ...
                                        return InkWell(
                                          ...
                                          child: CardProductMarketplaceWidget(
                                            key: Key(
                                                'Keyp1n_${gridViewIndex}_of_${gridViewProductsRecordList.length}'),
