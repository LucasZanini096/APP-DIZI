...
class UserPostsWidget extends StatefulWidget {
  ...
  static String routeName = 'UserPosts';
  static String routePath = '/userPosts';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsuariosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuariosRecord> userPostsUsuariosRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final userPostsUsuariosRecord = userPostsUsuariosRecordList.isNotEmpty
            ? userPostsUsuariosRecordList.first
            : null;
                      ...
                      child: StreamBuilder<List<PostsRecord>>(
                        stream: queryPostsRecord(
                          queryBuilder: (postsRecord) => postsRecord.where(
                            'posterUser',
                            isEqualTo: userPostsUsuariosRecord?.reference,
                          ),
                        ),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return Stack(
                                children: [
                                  PostCardWidget(
                                    key: Key(
                                        'Keyjyw_${listViewIndex}_of_${listViewPostsRecordList.length}'),
                                          ...
                                          var confirmDialogResponse =
                                              await showDialog<bool>(
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        title: Text(
                                                            'Você deseja deletar essa postagem?'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
