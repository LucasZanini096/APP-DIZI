  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsuariosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuariosRecord> createTaskUsuariosRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final createTaskUsuariosRecord = createTaskUsuariosRecordList.isNotEmpty
            ? createTaskUsuariosRecordList.first
            : null;
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await AgendaRecord.collection.doc().set({
                              ...createAgendaRecordData(
                                usuario: createTaskUsuariosRecord?.reference,
                                anotacao: _model.taskTextController.text,
                                dataFim: _model.datePicked,
                                situacao: TasksStatus.NaoIniciado.name,
                              ),
                              ...mapToFirestore(
                                {
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  ...
                                  content: Text('Boa sorte para realiza-lá'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
