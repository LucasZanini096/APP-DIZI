                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.asset(
                                            'assets/images/Imagem_do_WhatsApp_de_2025-03-24_(s)_16.31.27_6178a0e1.jpg',
                                            width: 172.0,
                                            height: 200.0,
                                            fit: BoxFit.cover,
                                          ),
                                                    ...
                                                    children: List.generate(
                                                      ...
                                                      return Container(
                                                        ...
                                                        child:
                                                            CardMateriaWidget(
                                                          key: Key(
                                                              'Key56h_${rowIndex}_of_${rowMateriaisNovoRecordList.length}'),
                                                          capaMaterial:
                                                      ...
                                                      children: List.generate(
                                                        ...
                                                        return Container(
                                                          ...
                                                          child:
                                                              CardMateriaWidget(
                                                            key: Key(
                                                                'Key6l0_${rowIndex}_of_${rowMateriaisNovoRecordList.length}'),
                                                            capaMaterial:
                                                                rowMateriaisNovoRecord
                                                                    .capaMaterial,
                                                            nomeMaterial:
                                      ...
                                      children: [
                                        ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(8.0),
                                          child: Image.asset(
                                            'assets/images/Imagem_do_WhatsApp_de_2025-03-24_(s)_16.31.08_1f0be963.jpg',
                                            width: 154.0,
                                            height: 200.0,
                                            fit: BoxFit.cover,
                                          ),
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return InkWell(
                                            ...
                                            child: CardTaskWidget(
                                              key: Key(
                                                  'Keyxij_${listViewIndex}_of_${listViewAgendaRecordList.length}'),
                                              taskName:
