...
import 'autentication_model.dart';
export 'autentication_model.dart';

class AutenticationWidget extends StatefulWidget {
  const AutenticationWidget({super.key});

  static String routeName = 'Autentication';
  static String routePath = '/autentication';
...
class _AutenticationWidgetState extends State<AutenticationWidget>
  ...
  late AutenticationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AutenticationModel());
