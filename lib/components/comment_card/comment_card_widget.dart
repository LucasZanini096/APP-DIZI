...
class _CommentCardWidgetState extends State<CommentCardWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CommentsPostRecord>(
      stream: CommentsPostRecord.getDocument(widget!.commentRef!),
      builder: (context, snapshot) {
        ...
        final cardReview1CommentsPostRecord = snapshot.data!;
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          cardReview1CommentsPostRecord.comment,
                          style:
                      ...
                      Padding(
                        ...
                        child: StreamBuilder<UsuariosRecord>(
                          stream: UsuariosRecord.getDocument(
                              cardReview1CommentsPostRecord.postUser!),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            if (!snapshot.hasData) {
                              return Center(
                            ...
                            return Row(
                              ...
                              children: [
                                ...
                                Text(
                                  dateTimeFormat(
                                    "d/M/y",
                                    cardReview1CommentsPostRecord.date!,
