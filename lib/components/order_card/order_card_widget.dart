                    ...
                    child: Padding(
                      ...
                      child: StreamBuilder<UsuariosRecord>(
                        stream: UsuariosRecord.getDocument(
                            containerOrdersRecord.vendedor!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
                          ...
                          final imageUsuariosRecord = snapshot.data!;
                            ...
                            children: [
                              StreamBuilder<MateriaisNovoRecord>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final textMateriaisNovoRecord =
                                      snapshot.data!;

                                  return Text(
                                    textMateriaisNovoRecord.nome,
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Text(
                                    dateTimeFormat(
                                      "d/M/y",
                                      containerOrdersRecord.dataOcorrencia!,
