...
import 'create_material_model.dart';
export 'create_material_model.dart';

class CreateMaterialWidget extends StatefulWidget {
  const CreateMaterialWidget({
    super.key,
    required this.cadernoRef,
  });

  final DocumentReference? cadernoRef;

  @override
  State<CreateMaterialWidget> createState() => _CreateMaterialWidgetState();
}

class _CreateMaterialWidgetState extends State<CreateMaterialWidget> {
  late CreateMaterialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateMaterialModel());
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        obscureText: false,
                        decoration: InputDecoration(
                          hintText: 'Digite a descrição do material',
                          hintStyle:
                              FlutterFlowTheme.of(context).bodyLarge.override(
                                    font: GoogleFonts.poppins(
                                      fontWeight: FlutterFlowTheme.of(context)
                      ...
                      StreamBuilder<List<NotebookCoversRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<NotebookCoversRecord>
                              capaMaterialNotebookCoversRecordList =
                              snapshot.data!;
                          ...
                          return SingleChildScrollView(
                            ...
                            child: Row(
                              ...
                              children: List.generate(
                                  capaMaterialNotebookCoversRecordList.length,
                                  (capaMaterialIndex) {
                                final capaMaterialNotebookCoversRecord =
                                    capaMaterialNotebookCoversRecordList[
                                        capaMaterialIndex];
                                return Container(
                                  width: 80.0,
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      FFAppState().CoverImageMaterialUrl =
                                          capaMaterialNotebookCoversRecord.url;
                                      safeSetState(() {});
                                    },
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(8.0),
                  ...
                  Column(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (selectedFiles != null) {
                            safeSetState(() =>
                                _model.isDataUploading_uploadDataS4w = true);
                            ...
                            try {
                              ...
                              _model.isDataUploading_uploadDataS4w = false;
                            }
                            if (selectedUploadedFiles.length ==
                                selectedFiles.length) {
                              safeSetState(() {
                                _model.uploadedLocalFile_uploadDataS4w =
                      ...
                      FlutterFlowPdfViewer(
                        fileBytes: _model.uploadedLocalFile_uploadDataS4w.bytes,
                        height: 300.0,
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      {
                        safeSetState(
                            () => _model.isDataUploading_uploadDataXtn = true);
                        var selectedUploadedFiles = <FFUploadedFile>[];
                        ...
                        try {
                          ...
                          selectedUploadedFiles = _model
                                  .uploadedLocalFile_uploadDataS4w
                                  .bytes!
                                  .isNotEmpty
                              ? [_model.uploadedLocalFile_uploadDataS4w]
                              : <FFUploadedFile>[];
                          ...
                          _model.isDataUploading_uploadDataXtn = false;
                        }
                        if (selectedUploadedFiles.length ==
                                selectedFiles.length &&
                            downloadUrls.length == selectedFiles.length) {
                          safeSetState(() {
                            _model.uploadedLocalFile_uploadDataXtn =
                                selectedUploadedFiles.first;
                            _model.uploadedFileUrl_uploadDataXtn =
                                downloadUrls.first;
                          });
                          showUploadMessage(
                            context,
                      ...
                      await MateriaisNovoRecord.collection
                          ...
                          .set(createMateriaisNovoRecordData(
                            ...
                            criador: columnUsuariosRecord?.reference,
                            tipoPagina: _model.pageTypeValue,
                            tipoModelo: _model.modelTypeValue,
                            capaMaterial: FFAppState().CoverImageMaterialUrl,
                            caderno: widget!.cadernoRef,
                            urlDoc: _model.uploadedFileUrl_uploadDataXtn,
                      ...
                      await showDialog(
                        ...
                        builder: (alertDialogContext) {
                          return AlertDialog(
                            title: Text('Material criado com sucesso!'),
                            actions: [
                              TextButton(
                                onPressed: () =>
