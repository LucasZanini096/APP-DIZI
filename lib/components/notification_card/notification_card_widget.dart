            ...
            child: Padding(
              ...
              child: StreamBuilder<UsuariosRecord>(
                stream: UsuariosRecord.getDocument(
                    containerNotificationsRecord.madeBy!),
                builder: (context, snapshot) {
                  // Customize what your widget looks like when it's loading.
                  if (!snapshot.hasData) {
                    return Center(
                  ...
                  return Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Image.network(
                          rowUsuariosRecord.photoBackground,
                          fit: BoxFit.cover,
                        ),
                      ),
                      Padding(
                      ...
                      Builder(
                        builder: (context) {
                          if (containerNotificationsRecord.isNewFollower ==
                              true) {
                            return Padding(
                          ...
                          } else if (containerNotificationsRecord.isALikePost ==
                              true) {
                            return Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  4.0, 0.0, 0.0, 0.0),
                          ...
                          } else if (containerNotificationsRecord.isAMessage ==
                              true) {
                            return Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  4.0, 0.0, 0.0, 0.0),
