...
import 'edit_notebook_model.dart';
export 'edit_notebook_model.dart';

class EditNotebookWidget extends StatefulWidget {
  const EditNotebookWidget({super.key});
...
class _EditNotebookWidgetState extends State<EditNotebookWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditNotebookModel());
      ...
      child: Padding(
        ...
        child: StreamBuilder<List<CadernosRecord>>(
          stream: queryCadernosRecord(
            queryBuilder: (cadernosRecord) => cadernosRecord.where(
              'id_caderno',
              isEqualTo: FFAppState().CadernoReference?.id,
            ),
            singleRecord: true,
          ),
          builder: (context, snapshot) {
            ...
            List<CadernosRecord> columnCadernosRecordList = snapshot.data!;
            // Return an empty Container when the item does not exist.
            if (snapshot.data!.isEmpty) {
              return Container();
            }
            final columnCadernosRecord = columnCadernosRecordList.isNotEmpty
                ? columnCadernosRecordList.first
                : null;
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                FFAppState().UpdateImageCover =
                                    'https://images.unsplash.com/photo-1477346611705-65d188';
                                safeSetState(() {});
                              },
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                          ...
                          Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                FFAppState().UpdateImageCover =
                                    'https://media.istockphoto.com/id/1960952508/pt/foto/dark-blue-gradient-soft-background.web';
                                safeSetState(() {});
                              },
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                ...
                FFButtonWidget(
                  onPressed: () async {
                    await columnCadernosRecord!.reference
                        .update(createCadernosRecordData(
                      nome: _model.nameNotebbokTextController.text,
                      usuario: columnCadernosRecord?.usuario,
                      capa: FFAppState().UpdateImageCover,
                    ));
                    ...
                    await showDialog(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          title: Text('Caderno atualizado com sucesso!'),
                          actions: [
                            TextButton(
                              onPressed: () =>
